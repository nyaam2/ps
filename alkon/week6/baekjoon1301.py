...
def go(prev,pprev,a,b,c,d,e):
    ...
    if a>0 and prev!=1 and pprev!=1:
        dp[prev][pprev][a][b][c][d][e]+=go(1,prev,a-1,b,c,d,e)
    if b>0 and prev!=2 and pprev!=2:
        dp[prev][pprev][a][b][c][d][e]+=go(2,prev,a,b-1,c,d,e)
    if c>0 and prev!=3 and pprev!=3:
        dp[prev][pprev][a][b][c][d][e]+=go(3,prev,a,b,c-1,d,e)
    if d>0 and prev!=4 and pprev!=4:
        dp[prev][pprev][a][b][c][d][e]+=go(4,prev,a,b,c,d-1,e)
    if e>0 and prev!=5 and pprev!=5:
        dp[prev][pprev][a][b][c][d][e]+=go(5,prev,a,b,c,d,e-1)
